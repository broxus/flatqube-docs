...
{% swagger method="post" path="/pairs/cross_pairs" baseUrl="https://ton-swap-indexer.broxus.com/v1" summary="Dex cross pairs data" %}
{% swagger-description %}
...
| Field name  | Example value   | Comment                                                                                                       |
| ----------- | --------------- | ------------------------------------------------------------------------------------------------------------- |
| `date`      | `0`             | Trading volume for the given moment inside of the given timespan, based on the timeframe (hourly, daily etc.) |
...
{% swagger method="post" path="/pairs/address/{address}/tvl" baseUrl="https://ton-swap-indexer.broxus.com/v1" summary="Pair tvl data" %}
{% swagger-description %}
...
This function needs to get pair TVL data info using the liquidity pool address.\
It can be used for graphic representation of trading volume changes in the pair’s pool over a certain period of time.
...
| ----------- | --------------- | ------------------------------------------------------------------------------------------------------------- |
| `date`      | `0`             | Trading volume for the given moment inside of the given timespan, based on the timeframe (hourly, daily etc.) |
| `timestamp` | `1649253600000` | Date time of the retrieved trading volume data                                                                |
